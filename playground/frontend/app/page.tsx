        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm rounded-2xl border border-slate-200 dark:border-slate-700 shadow-xl p-8 mb-8">
            ...
            <p className="text-slate-700 dark:text-slate-300 text-lg leading-relaxed mb-6">
              This demo showcases how to use a shared WebSocket connection to load multiple
              documents with real-time collaboration.
            </p>
            <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
              <p className="text-blue-800 dark:text-blue-200 font-medium">
                💡 Tip: Open a second tab or window and experience collaborative editing in
                real-time!
              </p>
            </div>
          </div>
          ...
          <div className="bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-200 dark:border-slate-700 p-6">
            ...
            <p className="text-slate-600 dark:text-slate-400 text-sm">
              Open your browser's developer console to see detailed connection and synchronization
              information.
            </p>
          </div>
        </div>
