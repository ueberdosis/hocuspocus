      ...
      <main className="flex-1 p-8">
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <HocuspocusProviderWebsocketComponent url="ws://localhost:8000">
              <HocuspocusRoom
                name={slug}
                onAuthenticationFailed={handleAuthFailed}
                onClose={data => console.log('[Editor 1] Connection closed:', data.event)}
                onSynced={data => console.log('[Editor 1] Synced:', data.state)}
              >
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-purple-700 dark:text-purple-300 mt-1">
                  This demo uses the new React-specific package. Each editor is wrapped in its own{' '}
