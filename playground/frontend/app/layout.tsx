					...
					<div className="w-64 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm border-r border-slate-200 dark:border-slate-700 shadow-sm">
						<div className="p-6">
							...
							<nav className="space-y-6">
								<div>
									<h2 className="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-3">Permission System</h2>
									<ul className="space-y-2">
										<li>
											<Link 
												href="/permissions" 
												className="flex items-center px-3 py-2 text-sm font-medium text-slate-700 dark:text-slate-300 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-blue-600 dark:hover:text-blue-400 transition-all duration-200 group"
											>
												<div className="w-3 h-3 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full mr-3 group-hover:scale-110 transition-transform"></div>
												<div>
													<div className="font-semibold">🔐 Permission Center</div>
													<div className="text-xs text-slate-500 dark:text-slate-400">Enterprise-grade access control</div>
												</div>
											</Link>
										</li>
									</ul>
