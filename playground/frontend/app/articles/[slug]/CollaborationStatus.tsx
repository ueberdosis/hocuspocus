...
const CollaborationStatus = (props: { provider: HocuspocusProvider }) => {
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      provider.configuration.websocketProvider.off('status', handleSocketStatus)
    }
  }, [provider])
  ...
  return (
    <div className="bg-white/60 dark:bg-slate-900/60 backdrop-blur-sm rounded-xl border border-slate-200 dark:border-slate-700 p-6">
        ...
        <div className="mb-4 p-3 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-xs text-red-600 dark:text-red-400">
              {unsyncedChanges} changes are waiting to sync. Your edits are saved locally but not
              yet on the server.
            </p>
          </div>
        </div>
      ...
      <div className="flex items-center justify-between mb-6">
        <h3 className="text-lg font-semibold text-slate-900 dark:text-white">Connection Status</h3>
        ...
        <div className="space-y-3">
          ...
          <div className="flex space-x-2">
            <button
              ...
              onClick={() => provider.configuration.websocketProvider.disconnect()}
