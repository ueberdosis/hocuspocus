...
export default function ArticleEditor({ slug }: { slug: string }) {
  ...
  useEffect(() => {
    ...
    const _p1 = new HocuspocusProvider({
      ...
      onAuthenticationFailed: data => console.log('Editor 1 onAuthenticationFailed', data),
      onUnsyncedChanges: data => console.log('Editor 1 onUnsyncedChanges', data),
      onStatus(data) {
    ...
    const _p2 = new HocuspocusProvider({
      ...
      onAuthenticationFailed: data => console.log('Editor 2 onAuthenticationFailed', data),
      onUnsyncedChanges: data => console.log('Editor 2 onUnsyncedChanges', data),
      onStatus(data) {
      ...
      <header className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm border-b border-slate-200 dark:border-slate-700">
        <div className="px-8 py-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Article #{slug}</h1>
        ...
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <h2 className="text-lg font-semibold text-slate-900 dark:text-white">Editor 1</h2>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <h2 className="text-lg font-semibold text-slate-900 dark:text-white">Editor 2</h2>
                <span className="text-sm text-slate-500 dark:text-slate-400">
                  Independent WebSocket connection
                </span>
              </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-blue-700 dark:text-blue-300 mt-1">
                  Both editors are connected to the same document but use separate WebSocket
                  connections. Changes made in one editor will appear in the other in real-time. Try
                  typing in either editor or use the connection controls to test synchronization
                  behavior.
                </p>
              </div>
            </div>
