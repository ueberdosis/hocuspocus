...
The playground is importing @hocuspocus packages from the packages folder, so you need to build them first. Run `npm run build:packages` in the repo root to do that.
