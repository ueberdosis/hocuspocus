...
Actually, you don't even have to use those 2 hooks! We have already created on top of them simple abstractions in the form of database extensions:

- [Database extension](https://tiptap.dev/docs/hocuspocus/server/extensions/database) - Generic database driver for any database
- [SQLite extension](https://tiptap.dev/docs/hocuspocus/server/extensions/sqlite) - Ready-to-use SQLite persistence  
- [S3 extension](https://tiptap.dev/docs/hocuspocus/server/extensions/s3) - Store documents in Amazon S3 or S3-compatible services
